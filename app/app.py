...
st.title("6. Propuesta de Startup: DengueTracker Selva")
st.subheader("Sistema de Alertas Tempranas de Dengue para la Región Selva del Perú")

st.header("6.1. Problema Específico")
st.write("""
...
st.header("6.2. Solución Digital: Plataforma DengueTracker Selva")
st.write("""
...
- **Alertas automáticas:** Notificaciones vía SMS, correo electrónico y app móvil dirigidas a personal de salud rural y urbano, y a municipalidades para activar fumigaciones y campañas preventivas.
...
st.header("6.3. Definiciones Clave")
st.subheader("Cliente y Aliados")
st.write("""
...
st.subheader("MVP (Mínimo Producto Viable)")
st.write("""
...
st.subheader("Métrica Estrella (North Star)")
st.write("Tiempo entre la predicción del brote y la implementación de medidas de control.")
...
st.subheader("¿Por qué esta solución es viable?")
st.write("""
